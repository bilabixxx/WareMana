...
<template>
  <IconBtn>
    ...
    <VMenu activator="parent" offset="21px" location="bottom end" width="340">
        ...
        <VCardItem class="py-3">
          ...
          <template #append>
            <IconBtn size="small" color="high-emphasis">
              <VIcon size="20" icon="bx-plus-circle" />
            </IconBtn>
          </template>
        </VCardItem>
        ...
        <PerfectScrollbar :options="{ wheelPropagation: false }">
          <VRow class="ma-0 mt-n1">
            <VCol v-for="(shortcut, index) in props.shortcuts" :key="shortcut.title" cols="6"
              class="text-center border-t cursor-pointer pa-6 shortcut-icon" :class="(index + 1) % 2 ? 'border-e' : ''"
